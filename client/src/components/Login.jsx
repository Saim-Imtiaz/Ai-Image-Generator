            ...
            className='relative bg-white p-10 rounded-xl text-slate-500'>
...

                {
                    ...
                    <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
                        <img src={assets.user_icon} width={20} className='opacity-60' />
                ...
                <button className='bg-blue-600 w-full text-white py-2 rounded-full'>{state === 'Login' ? 'Log in' : 'Sign up'}</button>
