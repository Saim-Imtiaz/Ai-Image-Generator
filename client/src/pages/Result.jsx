    ...
    className='flex flex-col min-h-[70vh] justify-center items-center'>
...

      {
        ...
        <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
          <input onChange={(e) => setInput(e.target.value)} value={input} type="text" placeholder='Descreibe what you want to generate.' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder-color' />
